...
def make_chunk6():
    ...
    # Build the PowerShell script string with $ vars
    script = 'Add-Type -AssemblyName System.Windows.Forms; ' + DL + 'fb = New-Object System.Windows.Forms.FolderBrowserDialog; ' + DL + 'fb.Description = ' + DQ + 'Select a folder' + DQ + '; if (' + DL + 'fb.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { ' + DL + 'fb.SelectedPath } else { ' + DQ + DQ + ' }'
    parts.append('        let script = ' + DQ + script + DQ + ';')
...
for line in text.split(chr(10)):
    if 'script' in line and 'Add-Type' in line:
        print('Script line:', line[:200])
