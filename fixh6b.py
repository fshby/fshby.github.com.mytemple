...
def make_chunk6():
    ...
    # PowerShell script - use single quotes for the description to avoid nested DQ
...
text = make_chunk6()
# Verify the script line
for line in text.split(chr(10)):
    if 'script = ' in line:
        print('Script line:', line[:250])
        # Count unescaped DQ
        dq_count = line.count(DQ)
        print('DQ count:', dq_count)
